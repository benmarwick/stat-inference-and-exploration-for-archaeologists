...
```{r, pca-3a, echo = FALSE, eval = FALSE, cache = TRUE, results = 'hide'}
...
```{r, code = knitr::knit_code$get("pca-3a"), eval = FALSE, echo = TRUE}
```
...
```{r, code = knitr::knit_code$get("k-2"), eval = FALSE, echo = TRUE}
```

```{r, code = knitr::knit_code$get("k-3a"), eval = FALSE, echo = TRUE}
```

```{r, code = knitr::knit_code$get("k-4"), eval = FALSE, echo = TRUE}
```
